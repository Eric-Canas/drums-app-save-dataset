...
export {CHART_LINE_COLOR, CHART_BACKGROUND_COLOR, CHART_LINE_COLOR2, CHART_BACKGROUND_COLOR2, CHART_LABEL, INVERT_Y_AXIS};
...
const RELEVANT_MARK = 6;

export {MIN_PART_CONFIDENCE, RIGHT, LEFT, MIN_WRIST_CONFIDENCE, HIT_WINDOW, NOISE_KERNEL,
        MIN_TOP_TO_BOTTOM_HIT_DISTANCE, RELEVANT_MARK, IS_HIT_CONFIDENCE_THRESHOLD, HIT_NET_PATH};
